  ...
  const onSubmitHandler = (e) => {
    ...
    if (isEmpty(category) && isEmpty(title) && isEmpty(price) && isEmpty(description) && isEmpty(continents) && image == null) {
      ...
      setErrorMsg("Error! Please enter a continents!");
        ...
        // formData.append("titleUpdate", data.title);
        // formData.append("priceUpdate", data.price);
        // formData.append("descriptionUpdate", data.description);
        // formData.append("continentsUpdate", data.continents);
        // formData.append("categoryUpdate", data.category);
        // formData.append("imageUpdate", data.image);
        // var option = {content: formData}
        // console.log(option)
        updateProduct(data)
        .then((response) => {
